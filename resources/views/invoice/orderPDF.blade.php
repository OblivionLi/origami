...
<body>
    ...
    <div class="container">
        <div>
            ...
            <p><span>Address:</span> {{ $user['addresses'][0]['country'] }}, {{ $user['addresses'][0]['city'] }}, {{ $user['addresses'][0]['address'] }}, {{ $user['addresses'][0]['postal_code'] }}</p>
            ...
            <table>
                ...
                <tr>
                    @foreach ($order['products'] as $or)
                        ...
                        <td>{{ $or->price }} &euro;</td>
                        <td>{{ $or->discount == null ? '0' : $or->discount }} %</td>
                        <td>{{ $or['pivot']['qty'] }}</td>
                    @endforeach
                </tr>
              </table>
