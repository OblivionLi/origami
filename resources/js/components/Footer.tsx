        ...
        <footer className="footer">
            <div className="footer-container">
                <div className="footer-container--links">
                    ...
                    <ul>
                        <li>
                            <GiGemNecklace className="icon"/> <Link className="footer-container-link"
                        ...
                        <li>
                            <MdLocalOffer className="icon"/> <Link className="footer-container-link"
                                                                   to="/special-offers">Special Offers</Link>
                        </li>
                    </ul>
                </div>
            ...
            <p className="footer-copyright">&copy; Copyright 2025</p>
        </footer>
    );
};
